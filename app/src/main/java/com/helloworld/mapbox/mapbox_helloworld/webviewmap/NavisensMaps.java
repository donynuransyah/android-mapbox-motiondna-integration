...
public class NavisensMaps extends Fragment implements NavisensPlugin {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        core = new NavisensCore(MainActivity.navisensDevKey,requireActivity());
        core.init(NavisensMaps.class).useLocalOnly().enableLocationSharing();
        core.setActivity(requireActivity());
    }
